...
─────────────────                    ─────────────────
"帮我加个积分任务功能"                 "帮我加个积分任务功能"
    ↓                                    ↓
Agent: 什么是积分任务？               Agent: 已读取知识库"任务系统"，
      你们用什么系统？                      基于现有赛事配置结构，
      有模板吗？                            开始生成prd-ir.yaml。
      权限怎么定？                          Gate 1：以下是计划摘要，
      ...（20个问题）                       请确认后继续。
```
...
- **你的业务复杂度高**。系统多、术语多、规则多，每次让 Agent 从头理解想死。
...
- **脱敏示例**：一份虚构的"Nova 赛事管理后台"从 0 到 1 完整走通
